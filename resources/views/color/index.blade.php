                            ...
                            @foreach ($models as $model)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('color.delete', $model->id) }}" method="post">
                                            @method('DELETE')
                                            @csrf
                                        ...
                                        <div class="modal fade" id="exampleModal1{{ $model->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" action="{{ route('color.edit', $model->id) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="file" name="img"
                                                                    value="{{ $model->img }}" class="form-control"
                                                                    id="exampleInputPassword1">

                                                                <img src="{{ $model->img }}" class="mt-2 ml-1"
                                                                    width="30%" alt="">
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
