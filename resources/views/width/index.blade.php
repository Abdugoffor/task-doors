            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="{{ route('width.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            @foreach ($models as $model)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('width.delete', $model->id) }}" method="post">
                                            @method('DELETE')
                                            @csrf
                                        ...
                                        <div class="modal fade" id="exampleModal1{{ $model->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" action="{{ route('width.edit', $model->id) }}"
